...
1. This performs simple functions like listening what you speak
2. then giving the text to gemini
3. then responding by voice using the speech recoginition module
